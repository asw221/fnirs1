...
FILES = ['./include/mcmc.o ./include/cholesky.o ./include/randgen.o', ...
    ' ./include/mybspline.o ./include/hrf.o ./include/knots.o', ...
    ' ./include/statistics.o ./include/config_info.o ./include/dlm.o', ...
    ' ./include/kernel_reg.o fitDlm.cpp'];
...
cd ../
mex -setup cpp
mex(FILES, ['-R', version('-release')], ...
    '-v', 'CXXFLAGS=''$CXXFLAGS -O2 -Wall -std=c++11''', ...
    INC, LIB);
